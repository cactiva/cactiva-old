...
import { Button, Icon, IconButton, Menu, Popover, Spinner } from "evergreen-ui";
...
export default observer(() => {
  ...
  return (
    <div className="start-container" style={{ fontFamily: fontFamily }}>
      <div className="start">
            ...
            ({
              ...
              choose: (
                <div className="projects">
                  {meta.list.length > 0 && (
                    <div className="list">
                      {meta.list.map((item: any, key: number) => (
                              ...
                              <div className="ctree-menu">
                                <Menu>
                                  <Menu.Item
                                    ...
                                    onSelect={() => {
                                      alert(
                                        "Sabar ya, sekarang masih belum bisa duplikat projek >_<"
                                      );
                                    }}
                                  >
                                    Duplicate
                                  ...
                                  <Menu.Item
                                    ...
                                    onSelect={async () => {
                                      ...
                                      if (
                                        ...
                                        await api.get(
                                          `project/del?name=${item.name}`
                                        );
                                        meta.list = (await api.get(
                                          "project/list"
                                        )).list;
                                      }
                                    }}
